...
def compact_text(value: str, max_chars: int) -> str:
    """Collapse whitespace and bound text for one-line review summaries."""
...
def compact_escaped_text(value: str, max_chars: int) -> str:
    """Escape Markdown-sensitive text before compacting review summary snippets."""
...
def comment_line(comment: dict[str, Any]) -> int:
    """Return the first relevant new-line number for a finding location.
