...
Continue at `WQ-16`: add focused context/DLP/store/MCP/receipt/approval data-flow tests in their existing owners, including safe-context auto-approval parity, fail-closed rejected or mutated required sources, hostile replay/readback, exact mixed-source counts, provider-neutral imports, and a non-GitLab fake provider. Do not push until `WQ-18`.
