...
9. [ ] Close the independently discovered development-provenance verification gap through a protected follow-up PR, then verify its exact TestPyPI development publisher, subjects, bytes, and installs.
