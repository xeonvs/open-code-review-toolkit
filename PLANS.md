...
Continue at `WQ-09`: add the three navigation-only indexes, reconcile links/README/strategy/roadmap, write integration-agent-readable Towncrier fragments including a separate maintenance removal inventory, pass the slice commit gate, and do not push.
