...
Unchanged: result and manifest schemas, inherited completion cap `16384`, explicit toolkit cap override `4096`, default `medium` effort, effective max-tools, private reasoning/session data, DLP, receipts, telemetry ownership, and approval authority.
