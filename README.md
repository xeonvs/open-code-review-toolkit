...
> [!NOTE]
> The project is under active development. It currently targets Python 3.12-3.14 on Linux and macOS; the public API, CLI, environment contract, and generated schemas may evolve before 1.0.
