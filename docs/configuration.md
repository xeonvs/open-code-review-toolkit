...
| **`OCR_TOOLKIT_VERSION`** | Example pipeline | Yes | `0.11.1` | Exact toolkit wheel release installed by the current published example. |
...
release publication; toolkit 0.11.1 supports the qualified OCR runtime.
