...
| **`OCR_TOOLKIT_VERSION`** | Example pipeline | Yes | `0.10.0` | Exact toolkit wheel release installed by the current published example. |
...
release publication; toolkit 0.10.0 supports the qualified OCR runtime.
