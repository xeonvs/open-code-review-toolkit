...
The **OCR compatibility** workflow qualifies stable upstream releases newer than
the manifest monitoring floor. Exact-tag manual dispatch is the
single-candidate path. A manual
